...
public class Subtract2Numbers {
	public static void main(String[] args){

        ClassWriter cw = new ClassWriter(ClassWriter.COMPUTE_FRAMES);
        cw.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC,"SubNum", null, "java/lang/Object",null);
        ...
        { //Multiply Int
            ...
            //Long
            mv.visitCode();
            mv.visitLdcInsn((long)673000L);
            mv.visitVarInsn(Opcodes.LSTORE,11);
            mv.visitLdcInsn((long)530000L);
